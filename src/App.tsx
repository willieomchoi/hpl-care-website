...
import IssuanceGuideOverlay from '@/IssuanceGuideOverlay';
import {
  AlertCircle,
  ArrowRight,
  Cake,
        ...
        <section id="top" className="hero-section overflow-hidden">
          <div className="site-shell grid min-h-[670px] items-center gap-12 py-16 lg:grid-cols-[0.95fr_1.05fr] lg:py-20">
            <div className="relative z-10">
              ...
              <p className="mt-6 max-w-[500px] text-[16px] leading-8 text-slate-600">나이, 경산시 거주 여부, BMI 기준을 간단히 ���인하고<br className="hidden sm:block" /> 신청에 필요한 건강보험 자격확인서도 미리 준비하세요.</p>
